...
import random
import sys
sys.path.append("C:\\Users\\hunmi\\OneDrive\\바탕 화면\\project\\ssj")
...
def bargraph(random5_df):
    import matplotlib.pyplot as plt
    random5_df = sj.random5_df.sample(n=5)
...
print(scattergraph(sj.dfc_fin))
print(bargraph(sj.dfc_fin))
